...
abstract class Controller
{
    ...
    private static function initializeBaseRoute(ReflectionClass $class): string
    {
        ...
        while ($parentClass !== false) {
            $rootPath .= self::initializeRootAttribute($parentClass);
            $parentClass = $parentClass->getParentClass();
        }
        return $rootPath . self::initializeRootAttribute($class);
    }

    private static function initializeRootAttribute(ReflectionClass $class): string
    {
